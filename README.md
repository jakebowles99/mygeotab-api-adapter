...
> **⚠️ Important Note**: The SQL Server Docker container included in this compose file is using Microsoft's SQL Server Developer Edition, which is not licensed for production use. For production deployments, you should:
